...
# from tkinter import ttk,Label,Entry,StringVar,Button,mainloop
...
class RealTimeCurrencyConverter():
    def __init__(self, url):
        ...
        self.currencies = self.data['rates'] #{"USD": 1,"AED": 3.67,"AFN": 96.17,"ALL": 107.02,"AMD": 489.42}
...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        self.date_label = Label(
            self, text=f"1 US Dollar equals = {self.currency_converter.convert('USD','TRY',1)} Turkish Lira \n Date : {self.currency_converter.data['date']}", relief=tk.GROOVE, borderwidth=5)
...
if __name__ == '__main__':
    ...
    converter = RealTimeCurrencyConverter(url) #url and data sent, like currency and rates
